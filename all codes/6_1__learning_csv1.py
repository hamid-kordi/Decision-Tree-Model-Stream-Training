...
# Prometheus metrics
MODEL_TRAINED_COUNT = Counter('model_trained_count_line_1', 'Number of models trained line 1')
MODEL_TESTED_COUNT = Counter('model_tested_count_line_1', 'Number of models tested line 1')
MODEL_ACCURACY = Histogram('model_accuracy_line_1', 'Model accuracy over time line 1')
MODEL_TRAINING_TIME = Histogram('model_training_time_seconds_line_1', 'Model training time in seconds line 1')

# CSV file paths
csv_file_path = "/home/hamidreza/Documents/bigdata/data/csv_file1.csv"
model_output_path = "/home/hamidreza/Documents/bigdata/model/model_s1"
csv_file_path_test = "/home/hamidreza/Documents/bigdata/data/csv_file2.csv"
model_output_path_test = "/home/hamidreza/Documents/bigdata/model/model_s1/final_model"
...
def insert_data(cursor, data):
    insert_query = "INSERT INTO accuracy_data_model1 (rmse, timestamp, time) VALUES (%s, %s, %s)"
...
def train_model(df: DataFrame):
    ...
    rf = RandomForestRegressor(featuresCol="features", labelCol="ArrDelay", numTrees=100, maxDepth=7,minInstancesPerNode=1)
