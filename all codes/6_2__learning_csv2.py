...
# Prometheus metrics
MODEL_TRAINED_COUNT = Counter('model_trained_count_line_2', 'Number of models trained line 2')
MODEL_TESTED_COUNT = Counter('model_tested_count_line_2', 'Number of models tested line 2')
MODEL_ACCURACY = Histogram('model_accuracy_line_2', 'Model accuracy over time line 2')
MODEL_TRAINING_TIME = Histogram('model_training_time_seconds_line_2', 'Model training time in seconds line 2')

# CSV file paths
csv_file_path = "/home/hamidreza/Documents/bigdata/data/csv_file2.csv"
model_output_path = "/home/hamidreza/Documents/bigdata/model/model_s2"
csv_file_path_test = "/home/hamidreza/Documents/bigdata/data/csv_file3.csv"
model_output_path_test = "/home/hamidreza/Documents/bigdata/model/model_s2/final_model"
...
start_http_server(8062)



def insert_data(cursor, data):
    insert_query = "INSERT INTO accuracy_data_model2 (rmse, timestamp, time) VALUES (%s, %s, %s)"
