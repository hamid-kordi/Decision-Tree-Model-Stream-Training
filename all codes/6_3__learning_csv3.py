...
# Prometheus metrics
MODEL_TRAINED_COUNT = Counter('model_trained_count_line_3', 'Number of models trained line 3')
MODEL_TESTED_COUNT = Counter('model_tested_count_line_3', 'Number of models tested line 3')
MODEL_ACCURACY = Histogram('model_accuracy_line_3', 'Model accuracy over time line 3')
MODEL_TRAINING_TIME = Histogram('model_training_time_seconds_line_3', 'Model training time in seconds line 3')

# CSV file paths
csv_file_path = "/home/hamidreza/Documents/bigdata/data/csv_file3.csv"
model_output_path = "/home/hamidreza/Documents/bigdata/model/model_s3"
csv_file_path_test = "/home/hamidreza/Documents/bigdata/data/csv_file4.csv"
model_output_path_test = "/home/hamidreza/Documents/bigdata/model/model_s3/final_model"
...
start_http_server(8063)



def insert_data(cursor, data):
    insert_query = "INSERT INTO accuracy_data_model3 (rmse, timestamp, time) VALUES (%s, %s, %s)"
